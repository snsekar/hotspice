...
public class DishApi {
	...
	public String getDish(@PathParam("dish_name") String dish_name) throws Exception{	
	...
	public String deleteDish(@PathParam("dish_name") String dish_name) throws Exception{	
		DBObject dish = DISHES.findOne(new BasicDBObject("dish_name", dish_name));
		if(dish == null){			
			return apiResponse("error","Dish not exists");
		}else{
	...
	public String searchDishes(@QueryParam("q") String q) throws Exception{		
	...
	public String recentlyOrdered() throws Exception{		
		ArrayNode ordersResult = objectMapper.readValue("[]", ArrayNode.class);		
	...
	public String mostlyOrdered() throws Exception{		
